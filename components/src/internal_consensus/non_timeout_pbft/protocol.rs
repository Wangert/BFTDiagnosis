use crate::internal_consensus::{non_timeout_pbft::common::{get_message_key, STABLE_CHECKPOINT_DELTA}};
use libp2p::PeerId;
use std::{
    cmp::Ordering,
...
use crate::internal_consensus::non_timeout_pbft::message::ConsensusMessage;

use crate::internal_consensus::non_timeout_pbft::message::{
    CheckPoint, Commit, MetaReply, NewView, PrePrepare, Prepare, ProofMessages, PublicKey, Reply, ViewChange,
};
use crate::message::Request;
use crate::internal_consensus::non_timeout_pbft::message::MessageType;

pub struct NonTimeoutPBFTProtocol {
    pub state: State,
...
impl Default for NonTimeoutPBFTProtocol {
    fn default() -> Self {
        Self {
...
impl NonTimeoutPBFTProtocol {
    ...
    fn handle_viewchange(&self) -> PhaseState {
        let mut send_query = VecDeque::new();
        PhaseState::ContinueExecute(send_query)
    }
...
impl ProtocolBehaviour for NonTimeoutPBFTProtocol {
